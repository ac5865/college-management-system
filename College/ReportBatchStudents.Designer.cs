namespace College
{
    partial class ReportBatchStudents
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.batchStudentBindingSource = new System.Windows.Forms.BindingSource(this.components);
            ...
            this.batchStudentTableAdapter = new College.App_Data.CollegeDataSetTableAdapters.BatchStudentTableAdapter();
            this.settingsBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.settingsTableAdapter = new College.App_Data.CollegeDataSetTableAdapters.settingsTableAdapter();
            ((System.ComponentModel.ISupportInitialize)(this.batchStudentBindingSource)).BeginInit();
            ...
            this.SuspendLayout();
            // 
            // batchStudentBindingSource
            // 
            this.batchStudentBindingSource.DataMember = "BatchStudent";
            this.batchStudentBindingSource.DataSource = this.collegeDataSet;
            // 
            // collegeDataSet
            // 
            ...
            // 
            this.settingsBindingSource1.DataMember = "settings";
            this.settingsBindingSource1.DataSource = this.collegeDataSet;
            // 
            // panel3
            // 
            ...
            reportDataSource1.Value = this.batchStudentBindingSource;
            reportDataSource2.Name = "DataSet2";
            reportDataSource2.Value = this.settingsBindingSource1;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource2);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "College.Reports.BatchStudent.rdlc";
            ...
            // 
            // batchStudentTableAdapter
            // 
            this.batchStudentTableAdapter.ClearBeforeFill = true;
            // 
            ...
            this.Name = "ReportBatchStudents";
            this.Text = "ReportBatchStudents";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.Load += new System.EventHandler(this.ReportBatchStudents_Load);
            ((System.ComponentModel.ISupportInitialize)(this.batchStudentBindingSource)).EndInit();
        ...
        private System.Windows.Forms.BindingSource batchStudentBindingSource;
        private App_Data.CollegeDataSet collegeDataSet;
        private App_Data.CollegeDataSetTableAdapters.BatchStudentTableAdapter batchStudentTableAdapter;
