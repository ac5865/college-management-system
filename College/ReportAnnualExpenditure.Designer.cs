namespace College
{
    partial class ReportAnnualExpenditure
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.annualExpenditureBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.annualExpenditureTableAdapter = new College.App_Data.CollegeDataSetTableAdapters.AnnualExpenditureTableAdapter();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.annualExpenditureBindingSource)).BeginInit();
            ...
            this.label2.Text = "ANNUAL EXPENDITURE";
            // 
            // panel2
            // 
            ...
            reportDataSource1.Value = this.annualExpenditureBindingSource;
            reportDataSource2.Name = "DataSet2";
            reportDataSource2.Value = this.settingsBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource2);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "College.Reports.AnnualExpenditure.rdlc";
            ...
            // 
            // annualExpenditureBindingSource
            // 
            this.annualExpenditureBindingSource.DataMember = "AnnualExpenditure";
            this.annualExpenditureBindingSource.DataSource = this.collegeDataSet;
            // 
            // annualExpenditureTableAdapter
            // 
            this.annualExpenditureTableAdapter.ClearBeforeFill = true;
            // 
            ...
            this.Name = "ReportAnnualExpenditure";
            ...
            ((System.ComponentModel.ISupportInitialize)(this.annualExpenditureBindingSource)).EndInit();
        ...
        private System.Windows.Forms.BindingSource annualExpenditureBindingSource;
        private App_Data.CollegeDataSetTableAdapters.AnnualExpenditureTableAdapter annualExpenditureTableAdapter;
