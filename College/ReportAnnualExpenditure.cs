...
namespace College
{
    public partial class ReportAnnualExpenditure : Form
    {
        public ReportAnnualExpenditure()
        {
            InitializeComponent();
        }
        ...
        private void ReportDailyExpenditure_Load(object sender, EventArgs e)
        {
            ...
            if (Common.command == true)
            {
                try
                {
                    ...
                    this.annualExpenditureTableAdapter.Fill(this.collegeDataSet.AnnualExpenditure, Common.year.ToString());
