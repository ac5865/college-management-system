...
namespace College
{
    public partial class ReportMonthlyFee : Form
    {
        public ReportMonthlyFee()
        {
            InitializeComponent();
        }
        ...
        private void ReportDailyExpenditure_Load(object sender, EventArgs e)
        {
            ...
            if (Common.command == true)
            {
                try
                {
                    ...
                    this.monthlyPaidFeeTableAdapter.Fill(this.collegeDataSet.MonthlyPaidFee, Common.month, Common.year);
