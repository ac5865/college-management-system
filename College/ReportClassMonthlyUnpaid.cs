...
namespace College
{
    public partial class ReportClassMonthlyUnpaid : Form
    {
        public ReportClassMonthlyUnpaid()
        {
            InitializeComponent();
        }
        ...
        private void ReportDailyExpenditure_Load(object sender, EventArgs e)
        {
            ...
            if (Common.command == true)
            {
                try
                {
                    ...
                    this.classUnpaidTableAdapter.Fill(this.collegeDataSet.ClassUnpaid, Common.month, Common.year, Common.classCode, Common.batchCode);
