...
namespace College
{
    public partial class ReportAnnualPaidFee : Form
    {
        public ReportAnnualPaidFee()
        {
            InitializeComponent();
        }
        ...
        private void ReportDailyExpenditure_Load(object sender, EventArgs e)
        {
            ...
            if (Common.command == true)
            {
                try
                {
                    ...
                    this.annualPaidFeeTableAdapter.Fill(this.collegeDataSet.AnnualPaidFee, Common.year);
